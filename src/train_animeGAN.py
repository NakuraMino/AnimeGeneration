...
def train_animeGAN(root_dir, anime_dir, photo_dir, logger_name, ckpt=None, 
    ...
    pl_trainer.fit(animeGAN, train_dl, val_dl)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--ckpt', type=str, default=None, help='load/resume from checkpoint. Should be a path (e.g. ./checkpoints/last.ckpt')
